...
//		total 表示总数
//实例: 
//http://127.0.0.1/project/artist/api/public/index.php?m=main&a=list
...
//		total 表示总数
//实例: 
//http://127.0.0.1/project/artist/api/public/index.php?m=main&a=ads
...
//
//实例: 
//http://127.0.0.1/project/artist/api/public/index.php?m=read&a=list
...
//
//实例: 
//http://127.0.0.1/project/artist/api/public/index.php?m=read&a=detail&id=10813
...
//
//实例: 
//http://127.0.0.1/project/artist/api/public/index.php?m=music&a=list
...
//		next数据,下一页
//实例: 
//http://127.0.0.1/project/artist/api/public/index.php?m=music&a=detail&id=10807
...
//实例: 
//http://127.0.0.1/project/artist/api/public/index.php?m=movie&a=list
...
//		next数据,下一页
//实例: 
//http://127.0.0.1/project/artist/api/public/index.php?m=movie&a=detail&id=10742
...
//实例: 
//http://127.0.0.1/project/artist/api/index.php?m=search&a=search&userId=1&keyword=121
...
//实例: 
//http://127.0.0.1/project/artist/api/public/index.php?m=user&a=login&username=zz&password=21212
...
//		成功: code=0
//		失败: code非0
//http://127.0.0.1/project/artist/api/public/index.php?m=user&a=register&username=zz&password=21212&phone=13600001111
...
//		成功: code=0
//		失败: code非0
//http://127.0.0.1/project/artist/api/public/index.php?m=user&a=changePassword&userId=1&&password=444&newPassword=5555
...
//		成功: code=0
//		失败: code非0
//http://127.0.0.1/project/artist/api/public/index.php?m=user&a=changeNickname&userId=1&&newNickname=haha
...
//		成功: code=0
//		失败: code非0
//http://127.0.0.1/project/artist/api/public/index.php
//	参数1: m
//	参数2: a
//  参数3: userId
//	参数4: newHeadImage
...
//		成功: code=0
//		失败: code非0
//http://127.0.0.1/project/artist/api/public/index.php?m=user&a=userInfo&userId=1
...
//Response
//	json:  {"code":0,desc:"ok",data:[]}
//http://127.0.0.1/project/artist/api/public/
...
//		失败: code非0
//
//http://127.0.0.1/project/artist/api/public/index.php?m=favorite&a=saveFavorite&userId=1&itemId=10813&type=1
...
//		失败: code非0
//
//http://127.0.0.1/project/artist/api/public/index.php?m=favorite&a=cancelFavorite&userId=6&itemId=1&type=1
...
//http://127.0.0.1/project/artist/api/public/index.php?m=favorite&a=isFavorite&userId=1&itemId=10813
...
//		失败: code非0
//
//http://127.0.0.1/project/artist/api/public/index.php?m=good&a=addGood&userId=1&itemId=10813
...
//		失败: code非0
//
//http://127.0.0.1/project/artist/api/public/index.php?m=good&a=cancelGood&userId=1&itemId=10813
...
//		失败: code非0
//
//http://127.0.0.1/project/artist/api/public/index.php?m=good&a=isGood&userId=1&itemId=10813
...
//http://127.0.0.1/project/artist/api/public/index.php?m=good&a=getGoodCount&itemId=10813
...
//		失败: code非0
//
//http://127.0.0.1/project/artist/api/public/index.php?m=comment&a=addComment&userId=1&itemId=10813&comment=aaaa
...
//		失败: code非0
//
//http://127.0.0.1/project/artist/api/public/index.php?m=comment&a=getComment&itemId=10813
